    ...
    [
        {
            ...
            "url_gambar": "romantic_wish.png",
            "tipe": "Eau de Parfum",
            "sex": "Unisex",
            "desc_first": "Manis, Bunga & Feminin",
            "stag": 'romantic-wisth-01'
        },
        {
            ...
            "tipe": "Eau de Parfum",
            "desc_first": "Segar, Tropis & Berani"
        },
        {
            "nama_produk": "Lovely",
            "harga": 55000,
            ...
            "url_gambar": "lovely.png",
            "tipe": "Eau de Parfum",
            "desc_first": "Lembut & Elegan"
        },
        {
            ...
            "url_gambar": "monaco_royal_melon.png",
            "tipe": "Eau de Parfum",
            "desc_first": "Segar , Melon & Berenergi"
        },
        {
            ...
            "url_gambar": "black_ovium.png",
            "tipe": "Eau de Parfum",
            "desc_first": "Kopi, Vanilla "
        },
        {
            ...
            "url_gambar": "dunhil_blue.png",
            "tipe": "Eau de Parfum",
            "desc_first": "Segar, Akuatik, dan Bersih."
        },
        {
            ...
            "url_gambar": "taylor_swift.png",
            "tipe": "Eau de Parfum",
            "desc_first": "Manis, Beri, dan Menawan."
        },
        {
            ...
            "url_gambar": "bvulgari_aqua.png",
            "tipe": "Eau de Parfum",
            "desc_first": "Segar, Laut, dan Murni."
        },
        {
            ...
            "url_gambar": "dior_savage.png",
            "tipe": "Eau de Parfum",
            "desc_first": "Ikonik, Jantan, dan Intens."
        },
        // {
        //     "nama_produk": "",
        //     "harga": 55000,
...
datajson.forEach(produk => {
    const productHTML = `
        <div style="border: 1px solid #f0f0f0; transition: 0.3s; text-align: center; padding-bottom: 25px; background: #fff;">
            <div style="height: 320px; background: #f9f9f9; margin-bottom: 25px; overflow: hidden; display: flex; justify-content: center; align-items: center;">
                <img src="poto_produk/${produk.url_gambar}" alt="${produk.nama_produk}" style="max-width: 80%; max-height: 80%; object-fit: contain;">
            </div>
            <h4 style="margin: 0; font-size: 19px; color: #04252b; letter-spacing: 1px; text-transform: uppercase;">${produk.nama_produk}</h4>
            <p style="color: #888; font-size: 14px; margin: 8px 0 20px; font-style: italic;">${produk.desc_first}</p>
            <div style="font-size: 18px; font-weight: bold; color: #04252b; margin-bottom: 20px;">Rp ${produk.harga.toLocaleString('id-ID')}</div>
            <a href="#" style="text-decoration: none; padding: 10px 25px; background: #04252b; color: white; border-radius: 4px; font-size: 13px;">Detail Produk</a>
        </div>
    `;
